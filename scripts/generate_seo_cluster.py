...
def sitemap() -> str:
    ...
    for slug in unique:
        ...
        lastmod = MODIFIED_DATE if slug in PAGES or slug in (
            "", "lichnye-finansy", "metodologiya", "skolko-mozhno-tratit",
